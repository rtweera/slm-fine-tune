...
# choreo_doc_assistant documentation build
...
from choreo_doc_assistant import __version__ as release

# -- Project information -----------------------------------------------------

project = "choreo_doc_assistant"
author = "Kedro"
...
htmlhelp_basename = "choreo_doc_assistantdoc"
...
latex_documents = [
    (
        master_doc,
        "choreo_doc_assistant.tex",
        "choreo_doc_assistant Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "choreo_doc_assistant",
        "Project choreo_doc_assistant codebase.",
        "Data-Science",
    )
]
